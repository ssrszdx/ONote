[大数据技术派](https://www.zhihu.com/people/ikeguang)
...
![](https://pic1.zhimg.com/v2-8cea5e6c35a0bd46b11d6c84f6aea098_b.gif)

列式

![](https://pic4.zhimg.com/v2-af2c9366b756a5ff20de67d2d8321fc3_b.gif)
...
支持SQL ClickHouse支持一种基于SQL的声明式查询语言，它在许多情况下与ANSI SQL标准相同。
...
没有完整的事务支持。 缺少高频率，低延迟的修改或删除已存在数据的能力。仅能用于批量删除或修改数据，但这符合 GDPR。 稀疏索引使得ClickHouse不适合通过其键检索单行的点查询。
